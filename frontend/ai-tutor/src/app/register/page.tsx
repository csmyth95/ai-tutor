     ...
     <div className="min-h-[calc(100vh-12rem)] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white shadow-md rounded-lg p-8">
        <div className="text-center mb-8">
          <h2 className="text-2xl font-bold text-gray-900">Welcome to MuinteoirAI</h2>
          <p className="mt-2 text-gray-600">Register your account here.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit"
            className="btn-primary w-full text-white py-2 px-4 rounded-lg hover:btn-secondary transition"
          >
            Register
          </button>
        </form>
